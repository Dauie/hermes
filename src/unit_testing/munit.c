...
static MunitParameterEnum ip4_cmp_test_params[] = {
		{ (char *)"class_a", ip_class_a },
		{ (char *)"class_b", ip_class_b},
...
static const MunitTest ip4_tests[] = {
		{ (char *)"ip4_cmp less-than", test_ip4_cmp_less, NULL, NULL, MUNIT_TEST_OPTION_NONE, ip4_cmp_test_params},
		{ (char *)"ip4_cmp greater-than", test_ip4_cmp_great, NULL, NULL, MUNIT_TEST_OPTION_NONE, ip4_cmp_test_params},
