...
SRC_FILES += manager.c partition.c binnify.c message.c thread.c unbinnify.c
SRC_FILES += scan.c print.c netlink.c
...
$(NAME):
		$(MAKE) -C $(LIBBINN)
		$(MAKE) -C $(LIBHERMES)
		$(CC) $(CFLAGS) $(SRC) src/main.c -lpthread -lpcap -o $(NAME)
